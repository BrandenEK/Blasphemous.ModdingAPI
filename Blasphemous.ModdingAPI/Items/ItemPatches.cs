...
internal class InventoryLayout_Patch
{
    ...
    {
        Vector2 itemCounts = Main.ModdingAPI.ItemHandler.GetItemCountOfType(___currentItemType);
...
internal class InventoryLayoutNav_Patch
{
    ...
    {
        int totalSlots = (int)Main.ModdingAPI.ItemHandler.GetItemCountOfType(___currentItemType).y;
